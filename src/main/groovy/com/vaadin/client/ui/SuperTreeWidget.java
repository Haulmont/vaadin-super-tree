...
public class SuperTreeWidget extends FocusElementPanel implements VHasDropHandler,
    ...
    public VLazyExecutor iconLoaded = new VLazyExecutor(50,
            new ScheduledCommand() {
                ...
                @Override
                public void execute() {
                    Util.notifyParentOfSizeChange(SuperTreeWidget.this, true);
                }

            });

    public SuperTreeWidget() {
        super();
        ...
        if (dropHandler == null) {
            dropHandler = new VAbstractDropHandler() {
                ...
                public ComponentConnector getConnector() {
                    return ConnectorMap.get(client).getConnector(SuperTreeWidget.this);
                }
    ...
    public class TreeNode extends SimplePanel implements ActionOwner {
        ...
        public void onBrowserEvent(Event event) {
            ...
            if (inCaption
                    && client.hasEventListeners(SuperTreeWidget.this,
        ...
        private void toggleSelection() {
            if (selectable) {
                SuperTreeWidget.this.setSelected(this, !isSelected());
            }
        }
        ...
        public void setState(boolean state, boolean notifyServer) {
            ...
            if (!rendering) {
                Util.notifyParentOfSizeChange(SuperTreeWidget.this, false);
            }
        }
        ...
        protected boolean isSelected() {
            return SuperTreeWidget.this.isSelected(this);
        }
